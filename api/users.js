...
export function getCartList (cookie) {
    const url = baseUrl + '/api/users/cartlist';

    if (cookie) Object.assign(config, { headers: { cookie } });
...
export function getAddressList (cookie) {
...
export function getOrderDetail (param, cookie) {
...
export function deleteOrder (orderId) {
  const url = baseUrl + '/api/users/deleteorder';
