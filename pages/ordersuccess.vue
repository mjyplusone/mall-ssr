<template>
  <div class="ordersuccess">
      ...
      <div class="ordersuccess-content">
          ...
          <div class="okimg">
              <img div="okimg" src="../assets/image/ok.png" alt="" width="100">
          </div>
          <div class="text">
              <p>下单成功</p>
              <p>您的订单正在处理中</p>
          ...
          <div class="btn-wrapper">
              ...
              <router-link tag="div" class="btn btn-goodlist" to="/">继续购物</router-link>
          </div>
      </div>
  </div>
</template>
...
export default {
    ...
    async asyncData ({query, req, res}) {
      ...
      let {status, result: { orderId, orderTotal }} = await getOrderDetail(param, cookies);
