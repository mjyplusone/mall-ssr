        ...
        <div class="order-content">
            ...
            <div class="order-list">
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="item in $store.state.orderList" :key="item.productId">
                            <td class="item-name">
                                <div>
...
export default {
    ...
    methods: {
        payMent () {
            ...
            createOrder(this.subPrice, this.shipping, this.$route.query.addressId, this.$store.state.orderList).then((res) => {
                if (res.status === '0') {
